...
addButton.addEventListener("click", () => {
  const ValidateCardnumber = document.querySelector("#card-number")
  const ValidateCardname = document.querySelector("#card-holder")
  const ValidateExpiration = document.querySelector("#expiration-date")
...
cardHolder.addEventListener("input", () => {
  ...
  ccHolder.innerText =
    cardHolder.value.length === 0 ? "PrimaCard" : cardHolder.value
})
